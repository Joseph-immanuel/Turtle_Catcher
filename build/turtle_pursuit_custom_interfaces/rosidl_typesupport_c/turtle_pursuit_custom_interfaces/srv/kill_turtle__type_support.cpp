...
static const _KillTurtle_Request_type_support_symbol_names_t _KillTurtle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_pursuit_custom_interfaces, srv, KillTurtle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_pursuit_custom_interfaces, srv, KillTurtle_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_pursuit_custom_interfaces, srv, KillTurtle_Request)() {
  return &::turtle_pursuit_custom_interfaces::srv::rosidl_typesupport_c::KillTurtle_Request_message_type_support_handle;
}
...
static const _KillTurtle_Response_type_support_symbol_names_t _KillTurtle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_pursuit_custom_interfaces, srv, KillTurtle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_pursuit_custom_interfaces, srv, KillTurtle_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_pursuit_custom_interfaces, srv, KillTurtle_Response)() {
  return &::turtle_pursuit_custom_interfaces::srv::rosidl_typesupport_c::KillTurtle_Response_message_type_support_handle;
}
...
static const _KillTurtle_type_support_symbol_names_t _KillTurtle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_pursuit_custom_interfaces, srv, KillTurtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_pursuit_custom_interfaces, srv, KillTurtle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtle_pursuit_custom_interfaces, srv, KillTurtle)() {
  return &::turtle_pursuit_custom_interfaces::srv::rosidl_typesupport_c::KillTurtle_service_type_support_handle;
}
