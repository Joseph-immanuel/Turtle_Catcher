...
class Metaclass_KillTurtle(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtle_pursuit_custom_interfaces.srv.KillTurtle')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtle_pursuit_custom_interfaces.srv import _kill_turtle
...
class KillTurtle(metaclass=Metaclass_KillTurtle):
    from turtle_pursuit_custom_interfaces.srv._kill_turtle import KillTurtle_Request as Request
    from turtle_pursuit_custom_interfaces.srv._kill_turtle import KillTurtle_Response as Response
