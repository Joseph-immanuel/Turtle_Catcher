...
{
  new (message_memory) turtle_pursuit_custom_interfaces::msg::AliveTurtleArray(_init);
}

void AliveTurtleArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtle_pursuit_custom_interfaces::msg::AliveTurtleArray *>(message_memory);
  typed_message->~AliveTurtleArray();
}

size_t size_function__AliveTurtleArray__turtles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<turtle_pursuit_custom_interfaces::msg::Turtle> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<turtle_pursuit_custom_interfaces::msg::Turtle> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<turtle_pursuit_custom_interfaces::msg::Turtle> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const turtle_pursuit_custom_interfaces::msg::Turtle *>(
    get_const_function__AliveTurtleArray__turtles(untyped_member, index));
  auto & value = *reinterpret_cast<turtle_pursuit_custom_interfaces::msg::Turtle *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<turtle_pursuit_custom_interfaces::msg::Turtle *>(
    get_function__AliveTurtleArray__turtles(untyped_member, index));
  const auto & value = *reinterpret_cast<const turtle_pursuit_custom_interfaces::msg::Turtle *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AliveTurtleArray_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<turtle_pursuit_custom_interfaces::msg::Turtle>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(turtle_pursuit_custom_interfaces::msg::AliveTurtleArray, turtles),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AliveTurtleArray_message_members = {
  "turtle_pursuit_custom_interfaces::msg",  // message namespace
  "AliveTurtleArray",  // message name
  1,  // number of fields
  sizeof(turtle_pursuit_custom_interfaces::msg::AliveTurtleArray),
...
{
  return &::turtle_pursuit_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::AliveTurtleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_pursuit_custom_interfaces, msg, AliveTurtleArray)() {
  return &::turtle_pursuit_custom_interfaces::msg::rosidl_typesupport_introspection_cpp::AliveTurtleArray_message_type_support_handle;
}
