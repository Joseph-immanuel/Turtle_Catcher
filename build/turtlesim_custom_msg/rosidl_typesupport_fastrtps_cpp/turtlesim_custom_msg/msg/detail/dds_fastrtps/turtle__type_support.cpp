...
#include "turtlesim_custom_msg/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtlesim_custom_msg::msg::Turtle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_custom_msg::msg::Turtle & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim_custom_msg::msg::Turtle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlesim_custom_msg::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_custom_msg::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &turtlesim_custom_msg::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_custom_msg, msg, Turtle)() {
  return &turtlesim_custom_msg::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
