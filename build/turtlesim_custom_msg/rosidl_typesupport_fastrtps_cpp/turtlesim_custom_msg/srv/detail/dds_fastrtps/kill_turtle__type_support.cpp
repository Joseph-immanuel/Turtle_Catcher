...
#include "turtlesim_custom_msg/srv/detail/kill_turtle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtlesim_custom_msg::srv::KillTurtle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_custom_msg::srv::KillTurtle_Request & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim_custom_msg::srv::KillTurtle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlesim_custom_msg::srv::KillTurtle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_custom_msg::srv::KillTurtle_Request *>(
    untyped_ros_message);
...
{
  return &turtlesim_custom_msg::srv::typesupport_fastrtps_cpp::_KillTurtle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_custom_msg, srv, KillTurtle_Request)() {
  return &turtlesim_custom_msg::srv::typesupport_fastrtps_cpp::_KillTurtle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim_custom_msg
cdr_serialize(
  const turtlesim_custom_msg::srv::KillTurtle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim_custom_msg::srv::KillTurtle_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlesim_custom_msg::srv::KillTurtle_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlesim_custom_msg::srv::KillTurtle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtlesim_custom_msg::srv::KillTurtle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtlesim_custom_msg::srv::typesupport_fastrtps_cpp::_KillTurtle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_custom_msg, srv, KillTurtle_Response)() {
  return &turtlesim_custom_msg::srv::typesupport_fastrtps_cpp::_KillTurtle_Response__handle;
}
...
{
  return &turtlesim_custom_msg::srv::typesupport_fastrtps_cpp::_KillTurtle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_custom_msg, srv, KillTurtle)() {
  return &turtlesim_custom_msg::srv::typesupport_fastrtps_cpp::_KillTurtle__handle;
}
