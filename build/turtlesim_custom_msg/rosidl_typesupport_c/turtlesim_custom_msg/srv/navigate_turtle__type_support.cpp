...
static const _NavigateTurtle_Request_type_support_symbol_names_t _NavigateTurtle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_custom_msg, srv, NavigateTurtle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_custom_msg, srv, NavigateTurtle_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_custom_msg, srv, NavigateTurtle_Request)() {
  return &::turtlesim_custom_msg::srv::rosidl_typesupport_c::NavigateTurtle_Request_message_type_support_handle;
}
...
static const _NavigateTurtle_Response_type_support_symbol_names_t _NavigateTurtle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_custom_msg, srv, NavigateTurtle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_custom_msg, srv, NavigateTurtle_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_custom_msg, srv, NavigateTurtle_Response)() {
  return &::turtlesim_custom_msg::srv::rosidl_typesupport_c::NavigateTurtle_Response_message_type_support_handle;
}
...
static const _NavigateTurtle_type_support_symbol_names_t _NavigateTurtle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_custom_msg, srv, NavigateTurtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_custom_msg, srv, NavigateTurtle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_custom_msg, srv, NavigateTurtle)() {
  return &::turtlesim_custom_msg::srv::rosidl_typesupport_c::NavigateTurtle_service_type_support_handle;
}
