...
class Metaclass_KillTurtle(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtlesim_custom_msg.srv.KillTurtle')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtlesim_custom_msg.srv import _kill_turtle
...
class KillTurtle(metaclass=Metaclass_KillTurtle):
    from turtlesim_custom_msg.srv._kill_turtle import KillTurtle_Request as Request
    from turtlesim_custom_msg.srv._kill_turtle import KillTurtle_Response as Response
