...
bool turtlesim_custom_msg__msg__turtle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlesim_custom_msg.msg._turtle.Turtle", full_classname_dest, 39) == 0);
  }
  turtlesim_custom_msg__msg__Turtle * ros_message = _ros_message;
  {  // name
...
PyObject * turtlesim_custom_msg__msg__turtle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlesim_custom_msg.msg._turtle");
