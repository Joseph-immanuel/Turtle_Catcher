...
bool turtle_pursuit_custom_interfaces__msg__turtle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtle_pursuit_custom_interfaces.msg._turtle.Turtle", full_classname_dest, 51) == 0);
  }
  turtle_pursuit_custom_interfaces__msg__Turtle * ros_message = _ros_message;
  {  // name
...
PyObject * turtle_pursuit_custom_interfaces__msg__turtle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_pursuit_custom_interfaces.msg._turtle");
